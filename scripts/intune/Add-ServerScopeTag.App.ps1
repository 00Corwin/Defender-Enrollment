<#
.SYNOPSIS
    App-only assignment of an existing Intune scope tag to Windows Server devices.
...
param(
    ...
    [int]$SleepMs=300,
    [string]$ReportPath=".\ServerScopeTag_App_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
)
